...
/**
 * Class that constructs a custom {@link android.widget.Adapter} by mapping <b>Instant*</b> annotated
 ...
 *
 * @param <T> The model you want to back using the {@link com.bttendance.adapter.kit.InstantAdapter}.
...
public class InstantAdapter<T> extends ArrayAdapter<T> {
    ...
    /**
     * Constructs a new {@link com.bttendance.adapter.kit.InstantAdapter} for your model.
     *
     * @param context          The {@link android.content.Context} to use.
     * @param layoutResourceId The resource id of your XML layout.
     * @param dataType         The data type backed by your adapter.
     * @param list             The {@link java.util.List} of instances backed by your adapter.
     */
    ...
    /**
     * Returns a {@link android.view.View} that has been inflated from the {@code layoutResourceId} argument in
