...
/**
 * A circular adapter that makes your {@link android.widget.ListView} appear circular.
 *
...
public class CircularListAdapter extends BaseAdapter {
    ...
    /**
     * Constructs a {@linkplain com.bttendance.adapter.kit.CircularListAdapter}.
     *
     * @param listAdapter A {@link android.widget.ListAdapter} that has to behave circular.
     */
